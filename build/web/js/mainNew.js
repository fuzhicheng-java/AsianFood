...
function initBuffers(obj, vertices, normals, faceIndices, edgeIndices) {
    function set(array) {
...
function init(canvas, m) {
    ...
    setModel(m, {compute_normals: true, normalize_scale: true,center_object: true});
}
